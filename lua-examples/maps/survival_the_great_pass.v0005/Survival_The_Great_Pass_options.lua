options = 
{
	{ 
		...
		values = { 
			...
			{text = "No Point Defense",		help = "No point defense turrets, only units can be used to protect your base. Based on Unit Survival (Hard)", key = "Unit", },
			{text = "Experimental Factory",	help = "Only Specially modified Experimental units will spawn. Based on Survival Expiremental Factory", key = "Factory", },
		}, 
	},
	{ 
		default = 1, 
	...
	{ 
		...
		values = { 
			...
			{text = "5:00",					help = "Slightly Faster Start", key = 300, }, 
			{text = "5:30 ",				help = "The Standard Build Time", key = 330, }, 
			{text = "6:00 (Extra)",			help = "A little extra build time, for inexpirenced players", key = 360, }, 
	...
	{ 
		...
		values = { 
			...
			{text = "Wave 5 (Quick Start)",	help = "Recommended for jumping right into the action", key = 4, }, 
			{text = "Wave 6",	help = "", key = 5, }, 
			{text = "Wave 7",	help = "", key = 6, }, 
			{text = "Wave 8",	help = "", key = 7, }, 
			{text = "Wave 9",	help = "", key = 8, },
			{text = "Wave 10",	help = "", key = 9, },  
			{text = "Wave 11",	help = "", key = 10, },  
			{text = "Wave 12",	help = "", key = 11, }, 
			{text = "Wave 13",	help = "", key = 12, }, 
			{text = "Wave 14",	help = "", key = 13, }, 
			{text = "Wave 15",	help = "", key = 14, }, 
			{text = "Wave 16",	help = "", key = 15, }, 
			{text = "Wave 17",	help = "", key = 16, }, 
			{text = "Wave 18",	help = "", key = 17, }, 
			{text = "Wave 19",	help = "", key = 18, },
			{text = "Wave 20",	help = "", key = 19, },  
			{text = "Wave 21",	help = "", key = 20, },  
			{text = "Wave 22",	help = "", key = 21, }, 
			{text = "Wave 23",	help = "", key = 22, }, 
			{text = "Wave 24",	help = "", key = 23, }, 
			{text = "Wave 25",	help = "", key = 24, }, 
			{text = "Wave 26",	help = "", key = 25, }, 
			{text = "Wave 27",	help = "", key = 26, }, 
			{text = "Wave 28",	help = "", key = 27, }, 
			{text = "Wave 29",	help = "", key = 28, },
			{text = "Wave 30",	help = "", key = 29, },  
	...
	{ 
		...
		values = { 
			...
			{text = "0:40 - (Enhanced)",help = "Quicker frequency", key = 40, }, 
	...
	{ 
		...
		values = { 
			{text = "Enable",	help = "Challenging Expiremental units will spawn every 5 to 10 waves", key = 1, }, 
