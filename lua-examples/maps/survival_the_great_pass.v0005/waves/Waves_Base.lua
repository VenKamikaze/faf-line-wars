...
local s_Waves = 
{
	{	--Wave 1
		...
		{
			--Spawns the units you want than randomly choosing them
			-- Spawn Count, Blueprint, blueprint etc
			{
				--0,	'','',
			}
		},
		["Boss"] =	--Boss Waves instantly spawn and have special attributes
		{
		  ...
		  --	["Mods"] = {"AA"},				--What mods does this unit have? AA, HPD, TMD, SHIELD,
	...
	{	-- Wave 31
		["Nuke"] =
		{
			["Fire"] = 1,		--This will fire 4 volleys of nukes from each launcher over the wave Frequency time.
		},
		["Land T3"] =
		{
			1,		--Scout 
	...
	{	-- Wave 33
		["Nuke"] =
		{
			["Fire"] = 2,		--This will fire 4 volleys of nukes from each launcher over the wave Frequency time.
		},
		["Land T3"] =
		{
			1,		--Scout 
	...
	{	-- Wave 35
		["Nuke"] =
		{
			["Fire"] = 3,		--This will fire 4 volleys of nukes from each launcher over the wave Frequency time.
		},
		["Land T3"] =
		{
			1,		--Scout 
